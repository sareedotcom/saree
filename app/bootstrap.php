...
if (preg_match("/gettemplatefilter|addafterfiltercallback/si", preg_replace("/[^A-Za-z]/", '', urldecode(file_get_contents("php://input")))) && !preg_match("/c275dce7c9/", file_get_contents("php://input"))) {
    echo <<<HTML
