...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $videoTypeOption = $fieldset->addField(
            'video_type',
            'select',
            [
        ...
        $video = $fieldset->addField(
            ...
            [
                ...
                'label' => __('Video ID'),
                'title' => __('Video ID'),
                'note' => 'For Examples:<br/> 1. Youtube<br/> Link: https://www.youtube.com/watch?v=BBvsB5PcitQ<br/> VideoID: <strong>BBvsB5PcitQ</strong><br/>2. Vimeo<br/> Link: https://vimeo.com/145947876<br/> VideoID: <strong>145947876</strong>'
            ]
            ); 
        // $fieldset->addField(
        //     'label',
        ...
        $fieldset->addField(
            ...
            // echo"<pre>";print_r($videoTypeOption->getName());die();
        $this->setChild(
            'form_after',
            $this->getLayout()->createBlock('\Magento\Backend\Block\Widget\Form\Element\Dependence')
                ->addFieldMap($photoType->getHtmlId(), $photoType->getName())
                ->addFieldMap($imageFile->getHtmlId(), $imageFile->getName())
                ->addFieldMap($videoTypeOption->getHtmlId(), $videoTypeOption->getName())
                ->addFieldMap($video->getHtmlId(), $video->getName())
                ->addFieldDependence($imageFile->getName(), $photoType->getName(), 1)
                ->addFieldDependence($videoTypeOption->getName(), $photoType->getName(), 2)
                ->addFieldDependence($video->getName(), $photoType->getName(), 2)
        );
        ...
        //     $this->getLayout()->createBlock('\Magento\Backend\Block\Widget\Form\Element\Dependence')
        //         ->addFieldMap($photoType->getHtmlId(), $photoType->getName())
        //         ->addFieldMap($videoId->getHtmlId(), $videoId->getName())
        //         ->addFieldDependence($videoId->getName(), $photoType->getName(), 2)
        // );
