    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('You saved the photo.'));
                ...
                if($this->getRequest()->getParam("duplicate")){
                    ...
                    try{
                        $banner->save();
                        $this->messageManager->addSuccess(__('You duplicated this photo.'));
                    } catch (\Magento\Framework\Exception\LocalizedException $e) {
                        $this->messageManager->addError($e->getMessage());
                    } catch (\RuntimeException $e) {
                        $this->messageManager->addError($e->getMessage());
                    } catch (\Exception $e) {
                        $this->messageManager->addException($e, __('Something went wrong while duplicating the photo.'));
                    }
                }
