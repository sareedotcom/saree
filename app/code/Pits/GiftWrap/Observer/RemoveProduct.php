    ...
    */
    ...
    public function updateQuoteGiftWrap($quoteItemId = false, $singleProduct= false)
    {
        ...
        if (!empty($quoteGiftWrapData)) {
            ...
            {
                $quoteGiftWrapData[WrapInterface::QUOTE_GIFT_WRAP_DATA_WHOLE_CART_IDENTIFIER] = $quoteGiftWrapData[WrapInterface::QUOTE_ITEMS_GIFT_WRAP_DATA_IDENTIFIER][$quoteItemId];
                $quoteGiftWrapData[WrapInterface::QUOTE_ITEMS_GIFT_WRAP_DATA_IDENTIFIER][$quoteItemId] = null;
            }
        }
