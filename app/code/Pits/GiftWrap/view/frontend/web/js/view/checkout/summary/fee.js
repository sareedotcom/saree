...
define(
    ...
    function (Component, quote, priceUtils, totals) {
        ...
        return Component.extend({
            ...
            /**
             * Get gift wrap fee not formatted
             *
             * @returns {*}
             */
            showGiftFee: function () {
                var show = false;
                if (this.totals() && totals.getSegment('giftwrap_fee')) {
                    show = (totals.getSegment('giftwrap_fee').value > 0);
                }
                return show;
            },
            ...
            /**
             * Get gift wrap fee title
             *
             * @returns {*}
             */
            getFeeTitle: function () {
                var label = '';
                if (window.checkoutConfig.giftWrapData) {
                    label = JSON.parse(window.checkoutConfig.giftWrapData).giftWrapFeeLabel;
                }
                return label;
            },
