...
class Data extends FrontendDataHelper {
    ...
    //OrderFactory $orderFactory,
            \Magento\Payment\Model\Method\Factory $orderFactory, \Magento\Store\Model\App\Emulation $appEmulation, \Magento\Payment\Model\Config $paymentConfig, \Magento\Framework\App\Config\Initial $initialConfig, \Magento\Ccavenuepay\Model\Cbdom_main $Cbdom_main, UrlInterface $backendUrl
    ) {
        parent::__construct($context, $storeManager, $orderFactory, $appEmulation, $paymentConfig, $initialConfig, $Cbdom_main);
