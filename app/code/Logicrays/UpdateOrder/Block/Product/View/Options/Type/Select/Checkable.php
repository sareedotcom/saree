...
namespace Logicrays\UpdateOrder\Block\Product\View\Options\Type\Select;
...
class Checkable extends \Magento\Catalog\Block\Product\View\Options\Type\Select\Checkable
{
     ...
     * @var string
     */
    protected $_template = 'Logicrays_UpdateOrder::product/composite/fieldset/options/view/checkable.phtml';
