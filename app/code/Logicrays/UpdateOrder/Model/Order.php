...
namespace Logicrays\UpdateOrder\Model;
...
use MageWorx\OrderEditor\Model\OrderCollectionFactoryBox;
...
class Order extends \MageWorx\OrderEditor\Model\Order
{
    ...
    public function calculateGrandTotal()
    {
        ...
        if ($this->checkTaxConfiguration()) {
            ...
            if($this->getCashOnDeliveryFee()){
                $grandTotal = $grandTotal + $this->getCashOnDeliveryFee();
            }
            $baseGrandTotal = $this->getBaseSubtotal()
                ...
                if($this->getBaseCashOnDeliveryFee()){
                    $baseGrandTotal = $baseGrandTotal + $this->getBaseCashOnDeliveryFee();
                }
        ...
        $baseGrandTotal = $baseGrandTotal + $giftWrepPrice;
        $grandTotal = $grandTotal + $giftWrepPrice;
