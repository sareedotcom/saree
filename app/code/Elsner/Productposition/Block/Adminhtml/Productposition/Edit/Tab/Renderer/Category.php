...
namespace Elsner\Productposition\Block\Adminhtml\Productposition\Edit\Tab\Renderer;
...
class Category extends Multiselect
{
    ...
    public function getElementHtml()
    {
        ...
        $html .= '<input name="categories_ids" data-bind="value: value" style="display: none"/>';
    ...
    {
        $isNotAllowed = !$this->authorization->isAllowed('Elsner_Productposition::category');
