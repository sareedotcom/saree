...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('productposition');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Elsner\Productposition\Model\Productposition')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('productposition/*/index');
    }
