...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getCurrentCategory()
    {
        ...
        return $this->objectManager->get('Magento\Framework\Registry')->registry('current_category');
    }
    ...
    public function getTransactionDetails()
    {
        ...
        return [
            'tvc_id'             => $tvc_order->getRealOrderId(),
    ...
    public function getSearchProducts()
    {
        ...
        $tvc_prod_obj = [];
        $parentId = [];
        $productdata = $this->objectManager->create('\Magento\Catalog\Model\ProductRepository')->getList($search_criteria);
        $productIds = array();
    ...
    public function getParentProducts($childId){
        ...
        return $this->objectManager->get('Magento\ConfigurableProduct\Model\Product\Type\Configurable')->getParentIdsByChild($childId);
    }
