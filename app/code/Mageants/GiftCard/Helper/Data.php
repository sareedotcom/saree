...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function sendTemplate($emailTemplateVariables)
    {
        ...
        $sender = ['name' => $this->_scopeConfig->getValue("trans_email/ident_sales/name", \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $storeId), 'email' => $this->_scopeConfig->getValue("trans_email/ident_sales/email", \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $storeId)];
