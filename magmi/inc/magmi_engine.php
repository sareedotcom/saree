    ...
    public function connectToMagento()
    {
        ...
        if (!$this->_connected) {
            ...
            if ($conn == 'localxml') {
                ...
                $host = $this->getProp("DATABASE", "host", "127.0.0.1");
                $dbname = $this->getProp("DATABASE", "dbname", "sareeM2");
                $user = $this->getProp("DATABASE", "user", "sareeM2");
                $pass = $this->getProp("DATABASE", "password", "34fqualW$b%j");
                $port = $this->getProp("DATABASE", "port", "22");
            }
